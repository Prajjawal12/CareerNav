...
function Expectations() {
  ...
  const onFormSubmit = async (e) => {
    ...
    try {
      const prompt = `For an entered name of a career course/career/working profession field, write a short paragraph on what kind of work is expected to be done and how to prepare to become successful in that field. Also, give examples of a few famous people of that profession, three international and two Indian if possible. If the profession is limited to India, like government jobs, then just show examples from India only: ${formDataObj.productName}`;
