...
function Scope_Future() {
  ...
  const onFormSubmit = async (e) => {
    ...
    try {
      const prompt = `For an entered name of a career course/career field, write a paragraph describing the scope, future, and salary (i.e., whether there is a good pay or not) of the mentioned course/field: ${formDataObj.productName}`;
