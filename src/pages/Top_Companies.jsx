  ...
  const onFormSubmit = (e) => {
    ...
    openai
      .createCompletion({
        ...
        prompt: `For an entered name of a career course/career field,write the name of top companies,their headquarters in which city/country and their founder, why they are the best and whether the pay their is high or not,if possible try to keep it in indian context,use international companies if such companies are not in India : ${formDataObj.productName}\n`,
        temperature: 1,
        max_tokens: 512,
        top_p: 1,
        frequency_penalty: 0,
